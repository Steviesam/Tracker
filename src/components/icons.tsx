/**
 * Inline stroke icons, so the app pulls in no icon dependency. All are 24x24 on a
 * `currentColor` stroke and size themselves from the className passed in.
 */
...
export const IconComment = (p: IconProps) => (
  <Svg {...p}>
    <path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 9 9 0 0 1-3.9-.9L3 20.5l1.5-4.6A8.4 8.4 0 0 1 3.6 11 8.4 8.4 0 0 1 12 3a8.4 8.4 0 0 1 9 8.5z" />
  </Svg>
);
